...
knitr::include_graphics("fig/schema/abm_concept.png")
```
...
denoted *pChangeTeam*, (value between 0 and 1), set as 0.05 by default
([Sources]{style="color:red"}).
...
knitr::include_graphics("fig/schema/abm_infection_4M.png")
```
