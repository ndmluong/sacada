...
The secondary attack rate (SAR) is the parameter used to estimate the
...
The initial source of sars-cov transfer in the food plant environment is
through the exhalation of infected workers. The droplet rate is
expressed as
