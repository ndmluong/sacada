...
Parms_Food <- list(
  ...
  worker_rhythm = list( 
    porcine = c("logistic1" = 0.5, # transfer the equivalent of one carcass per minute from the arrival gate to the conveyor
                "cutter1" = 0.2, # cut the equivalent 20% of one carcass per minute, one entire carcass every 5 minutes (assumption/experts) 
                "cutter2" = 0.05,# cut equivalent 10% of one carcass per minute, half-carcass every 5 minutes (assumption/experts) 
                "logistic2" = 0.25), # process (e.g.) and transfer the equivalent of a half-carcass per minute to the storage area
