...
<span style="color:red">NWorkers not yet used</span>
...
Moreover, this worker can alternatively change the working shift (morning/afternoon) from one week to another, and so change of team. The proportion of workers is definided in **pChangeTeam** (0 to 1). The value will be 0.05 (5%) <span style="color:red"> Sources </span>.



#### Parameters will be may be implemented

Worker types with important mission having high probabilities to be present at work despite their possible contamination/symptoms
...
- the total duration that will be simulated ("NDays" in the ABM, in days), for example, 365 days; 
- the simulated time interval of the simulation ("Step" in the ABM, in minutes), for example 5 minutes.
