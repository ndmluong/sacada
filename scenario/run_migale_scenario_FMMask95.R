...
## Scenario FMMask95 - 95% mask acceptability (check the XLSX file)
Parms_Workers$pMaskAcceptability[[Parms_Workers$MaskType]] <- 0.95
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMMask95_", MySeed,".RData", sep ="")
