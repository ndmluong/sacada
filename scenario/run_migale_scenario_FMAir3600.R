...
## Scenario FMAir3600 - air renewal of the cutting room ! (check the XLSX file)
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMAir3600_", MySeed,".RData", sep ="")
