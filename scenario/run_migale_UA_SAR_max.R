...
## Uncertainty analysis - UA_RNAr_max (check the XLSX file)
Parms_Workers$SAR[[Parms_Workers$SAR_sim]] <- 0.53
Parms_Workers$daily_SAR[[Parms_Workers$SAR_sim]] <- 0.053
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_UA_SAR_max_", MySeed,".RData", sep ="")
