...
## Scenario FMMask90 - 90% mask acceptability (check the XLSX file)
Parms_Workers$pMaskAcceptability[[Parms_Workers$MaskType]] <- 0.9
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMMask90_", MySeed,".RData", sep ="")
