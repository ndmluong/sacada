...
## Scenario FMAir1200 - air renewal of the cutting room ! (check the XLSX file)
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMAir1200_", MySeed,".RData", sep ="")
