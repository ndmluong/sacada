...
## Scenario FMMask20 - 40% mask acceptability (check the XLSX file)
Parms_Workers$pMaskAcceptability[[Parms_Workers$MaskType]] <- 0.4
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMMask40_", MySeed,".RData", sep ="")
