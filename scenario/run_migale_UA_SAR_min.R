...
Parms_Workers$SAR[[Parms_Workers$SAR_sim]] <- 0.24
Parms_Workers$daily_SAR[[Parms_Workers$SAR_sim]] <- 0.024
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_UA_SAR_min_", MySeed,".RData", sep ="")
