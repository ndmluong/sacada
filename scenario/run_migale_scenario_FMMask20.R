...
## Scenario FMMask20 - 20% mask acceptability (check the XLSX file)
Parms_Workers$pMaskAcceptability[[Parms_Workers$MaskType]] <- 0.2
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMMask20_", MySeed,".RData", sep ="")
