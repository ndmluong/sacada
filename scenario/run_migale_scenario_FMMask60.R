...
## Scenario FMMask60 - 60% mask acceptability (check the XLSX file)
Parms_Workers$pMaskAcceptability[[Parms_Workers$MaskType]] <- 0.6
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMMask60_", MySeed,".RData", sep ="")
