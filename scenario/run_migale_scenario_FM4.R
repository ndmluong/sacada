...
## Scenario FM4 ## remove air renewal of the cutting room and remove all masks! (check the XLSX file)
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FM4_", MySeed,".RData", sep ="")
