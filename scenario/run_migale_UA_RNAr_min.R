...
## Uncertainty analysis - UA_RNAr_min (check the XLSX file)
Parms_Conta$RNA_virion_ratio <- 100
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_UA_RNAr_min_", MySeed,".RData", sep ="")
