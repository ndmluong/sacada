...
## Uncertainty analysis - UA_pSneeze_min (symptomatic) (check the XLSX file)
Parms_Air$p_sneeze[["infectious"]] <- 0
Parms_Air$p_sneeze[["symptomatic"]] <- 0
Parms_Air$p_sneeze[["asymptomatic"]] <- 0
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_UA_psneeze_min_", MySeed,".RData", sep ="")
