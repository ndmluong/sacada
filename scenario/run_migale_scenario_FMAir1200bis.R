...
## Scenario FMAir1200 - air renewal of the cutting room in absence of masks ! (check the XLSX file)
Parms_Plant$Air_renewal <- 1200 
...
## > output file name  ####
output_filename <- paste("simulation_output/", MySeed, "/", "output_FMAir1200bis_", MySeed,".RData", sep ="")
